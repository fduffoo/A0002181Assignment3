...
// INF 651
// 9/26/2022
/* Practice Assignment 3: Complete this javascript file according to the individual instructions given in the comments. 
...
const question1 = (myNumber) => { let myDept; 
    ...
    // The variables are already declared. 
    // Do not change the existing code. 
    const question2 = (myValue) => { let myLang; 
        /////// write your IF statement below this line ///////// 
    ...
    // The variables are already declared. 
    // Do not change the existing code. 
    const question3 = (myValue) => { let myLang; 
        /////// write your IF statement below this line ///////// 
        if(myValue.length==10)
            myLang="JavaScript";
...
// The variables are already declared. 
// Do not change the existing code. 
const question4 = (myNumber) => { let myFaveFood; 
...
// The variables are already declared. 
// Do not change the existing code
const question5 = (myTemp) => { let myWeather; 
